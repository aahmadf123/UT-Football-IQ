 ...
 *   2. resolve a signed download URL from the backend,
 *   3. render a <video> element whose src is the signed URL.
 *
 * The download endpoint is observed and asserted on so this test verifies
 * the upload→inbox→review path actually exercises the signed download flow
